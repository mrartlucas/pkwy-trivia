...
import { 
  ...
  Eye, EyeOff, Home, Tv, Volume2, VolumeX,
  CheckCircle2, Clock
} from 'lucide-react';
...
const DirectorPanel = () => {
  ...
  const handleStart = () => {
    ...
    toast({ title: 'Game Started!', description: 'TV display is now showing questions' });
  };
  ...
  const handleNext = () => {
    if (currentQuestion < mockQuestions.length - 1) {
      ...
      setShowAnswer(false);
      toast({ title: 'Next Question', description: `Question ${currentQuestion + 2}` });
    }
  };
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2">
            <Card>
              <CardHeader>
                <CardTitle>
                  Current Question ({currentQuestion + 1}/{mockQuestions.length})
                </CardTitle>
              </CardHeader>
                ...
                {showAnswer && (
                  <div className="bg-green-50 border-l-4 border-green-500 p-4">
                    <p className="font-semibold text-green-900">
                      Correct Answer: {question.options ? question.options[question.correctAnswer] : 'N/A'}
                    </p>
                  </div>
                )}
              </CardContent>
